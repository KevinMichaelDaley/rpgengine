...
parent: rpg-2lyk
---
# LA gen D4: Fence and barrier run generator
...
ferrum.la_fence per doc D4: chain-link / razor-top / plywood hoarding / wrought iron, lean, the player-sized gap.
...
Story options: breach (worn-path gap); regime_topper; memorial. Breakers: style family, height, lean/collapse runs.
