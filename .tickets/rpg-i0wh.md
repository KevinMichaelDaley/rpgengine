...
parent: rpg-2lyk
---
# LA gen C3: Parking structure generator
...
ferrum.la_parking per doc C3: floor stack, ramp internal/external helix, open-cable vs precast edges, stripe paint, stair tower, rooftop sign.
...
Story options: impound (crushed stacks); market_deck; collapse_corner. Breakers: helix vs internal ramp, edge system swap, half-level split-deck mode. Interior: decks/ramps walkable by definition.
