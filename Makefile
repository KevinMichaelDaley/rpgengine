...
build/frustum_cull_tests: tests/renderer/frustum_cull_tests.c src/renderer/cull/frustum_cull.c src/math/mat4_proj.c src/math/mat4_look_at.c src/math/mat4_mul.c src/math/mat4_basic.c src/math/vec3.c | build
	$(CC) $(CFLAGS) tests/renderer/frustum_cull_tests.c src/renderer/cull/frustum_cull.c src/math/mat4_proj.c src/math/mat4_look_at.c src/math/mat4_mul.c src/math/mat4_basic.c src/math/vec3.c -o $@ -lm
...
test: $(BIN_HEADLESS) build/p008_net_replication_protocol_tests build/p000_job_queue_sharding_tests build/p000_job_queue_diagnostics_tests build/p000_ws_deque_tests build/p007_net_client_rx_tests build/p007_net_client_rx_udp_topic_tests build/p007_net_topic_dispatch_tests build/npc_kg_astar_tests build/npc_kg_spatial_tests build/scene_desc_tests build/render_config_tests build/gl_constants_tests build/frustum_cull_tests build/probe_tests build/asset_stream_tests build/collider_prim_tests build/gi_collider_pose_tests build/server_level_load_tests build/stream_priority_tests
