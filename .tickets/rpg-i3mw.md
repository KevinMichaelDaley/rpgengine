...
parent: rpg-2lyk
---
# LA gen F1: Aberration monolith graft
...
ferrum.la_ab_graft per doc F1: smooth prismatic volume interpenetrating a host, cant angle, facets, emissive seam channels, gunmetal/bone/void materials.
...
State enum instead: dormant/active/damaged (dark vs pulsing vs cracked-leaking). Breakers: facet family, cant, host-intersection depth.
