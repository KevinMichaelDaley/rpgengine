...
parent: rpg-2lyk
---
# LA gen B3: Broadway theater front generator
...
ferrum.la_theater_front per doc B3: facade graft (terracotta/churrigueresque/deco ornament), marquee + blade sign, seeded letter-board gibberish, ground floor theater/discount/boarded.
...
Story options: marquee_edict; walled_doors; projection_alive. Breakers: marquee form (flat/vee/none), blade sign on/off, ornament era swap. Interior: lobby shell + mezzanine stub.
