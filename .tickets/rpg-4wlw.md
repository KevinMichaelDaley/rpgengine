...
---
# scripting texture synthesis API bindings

Implement scripting bindings for the texture synthesis system.
...
- Workspace is script userdata with __gc metamethod for cleanup
