...
parent: rpg-2lyk
---
# LA gen E1: Weathering pass (selection operator)
...
ferrum.la_weather per doc E1: sun-bleach gradients, grime streaks under sills/scuppers, stucco crack decals at opening corners, mismatched patch-paint rectangles. Vertex-color mask driven.
...
Story presets: decade_abandoned; regime_scrubbed; dust_storm_aftermath (intensity presets ARE the story tier for passes).
