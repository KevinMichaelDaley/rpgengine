...
static void emit_face(procgen_mesh_t *m,
    ...
    if (axis == 0) {
        ...
        if (sign > 0) {
            /* +X: engine reference (x1,y0,z0)→(x1,y0,z1)→(x1,y1,z1) */
            ...
            /* -X: engine reference (x0,y0,z1)→(x0,y0,z0)→(x0,y1,z0) */
        ...
        if (sign > 0) {
            /* +Y: engine reference (x0,y1,z0)→(x1,y1,z0)→(x1,y1,z1) */
            ...
            /* -Y: engine reference (x0,y0,z1)→(x1,y0,z1)→(x1,y0,z0) */
            v[0]=x0;v[1]=yy;v[2]=z1; v[3]=x1;v[4]=yy;v[5]=z1; v[6]=x1;v[7]=yy;v[8]=z0;
            v[9]=x0;v[10]=yy;v[11]=z1; v[12]=x1;v[13]=yy;v[14]=z0; v[15]=x0;v[16]=yy;v[17]=z0;
        }
    } else {
        float zz = (sign > 0) ? z1 : z0;
        if (sign > 0) {
            /* +Z: engine reference (x0,y0,z1)→(x0,y1,z1)→(x1,y1,z1) */
            v[0]=x0;v[1]=y0;v[2]=zz; v[3]=x0;v[4]=y1;v[5]=zz; v[6]=x1;v[7]=y1;v[8]=zz;
            v[9]=x0;v[10]=y0;v[11]=zz; v[12]=x1;v[13]=y1;v[14]=zz; v[15]=x1;v[16]=y0;v[17]=zz;
        } else {
            /* -Z: engine reference (x1,y0,z0)→(x1,y1,z0)→(x0,y1,z0) */
            v[0]=x1;v[1]=y0;v[2]=zz; v[3]=x1;v[4]=y1;v[5]=zz; v[6]=x0;v[7]=y1;v[8]=zz;
            v[9]=x1;v[10]=y0;v[11]=zz; v[12]=x0;v[13]=y1;v[14]=zz; v[15]=x0;v[16]=y0;v[17]=zz;
        }
    }
    m->vertex_count += 18;
}
