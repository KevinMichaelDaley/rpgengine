...
parent: rpg-2lyk
---
# LA gen C4: Power-line canopy generator
...
ferrum.la_powerlines per doc C4: catenary wire runs (curve-bevel), wood/steel poles, crossarms, transformers, service drops, cobra-head lamps, dead-sag fraction. Along picked curve or straight run.
...
Story options: tapped (illegal tap webs); dead_grid; regime_trunk. Breakers: wood vs steel poles, alley vs street rhythm, transformer clustering.
