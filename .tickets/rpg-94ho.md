...
ferrum.la_ab_stalk per doc F2: roof/pole sensor heads (tri-eye/ring/dish), too-clean cable drops, optional sweeping spot light entity.
...
State enum: dormant/active/damaged. Breakers: head family, mount type, cable routing.
