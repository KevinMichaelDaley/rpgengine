...
Story options: crown_graft; dark_floors; banner_drop. Breakers: setback count/rhythm, crown form, corner entrance chamfer. Interior: core + ring corridor + column grid per tier.
