...
static const ctrl_cmd_def_t s_defs[] = {
    ...
    },
    {
        ...
        .alias   = "g",
        .usage   = "group &name",
        .help    = "Create named group from selection with auto-pivot.",
        .arg_fmt = "s:name",
    },
    {
        .name    = "ungroup",
        .alias   = "ug",
        .usage   = "ungroup &name",
        .help    = "Dissolve a named group.",
        .arg_fmt = "s:name",
    },
    {
        .name    = "select_group",
        .alias   = "sg",
        .usage   = "select_group &name",
        .help    = "Select all entities in a named group.",
        .arg_fmt = "s:name",
    },
    {
        .name    = "group_info",
        .alias   = "gi",
        .usage   = "group_info &name",
        .help    = "Show info about a named group.",
        .arg_fmt = "s:name",
    },
    {
        .name    = "asset_list",
