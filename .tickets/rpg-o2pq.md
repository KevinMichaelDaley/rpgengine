...
parent: rpg-2lyk
---
# LA gen B2: Googie pylon / roadside sign generator
...
ferrum.la_googie_sign per doc B2: starburst/parabola/blade/bowling-pin styles, dead-neon tube split (live emissive vs dark glass), cabinet lighting, rust streaks.
...
Story options: resistance_overpaint; roost; half_relit (regime palette). Breakers: pylon family swap, cabinet count, road vs roof mount.
