...
parent: rpg-2lyk
---
# LA gen D3: Palm / dead-tree row generator
...
ferrum.la_palms per doc D3: alive/dead split (bare trunk + skirt stubs), height range, spacing.
...
Story options: all_dead; hung_markers; one_green. Breakers: staggered heights, single vs double row.
