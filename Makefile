...
build/lm_gpu_voxelize_tests: tests/lightmap/lm_gpu_voxelize_tests.c src/lightmap/gpu/lm_gpu_voxelize.c src/renderer/egl_headless.c include/ferrum/lightmap/gpu/lm_gpu_voxelize.h | build
	$(CC) $(CFLAGS) -D_POSIX_C_SOURCE=200809L tests/lightmap/lm_gpu_voxelize_tests.c src/lightmap/gpu/lm_gpu_voxelize.c src/renderer/egl_headless.c -o $@ -lEGL -lGL -ldl -lm
...
LM_HALL_BAKE_SRC := src/mesh/dmesh_load.c src/mesh/obj_mesh_load.c \
  ...
  src/lightmap/gpu/lm_gpu_gather.c src/lightmap/gpu/lm_gpu_voxelize.c src/lightmap/gpu/lm_gpu_chunk_mat.c \
