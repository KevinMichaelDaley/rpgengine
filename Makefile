...
build/lm_mesh_bake_tests: tests/lightmap/lm_mesh_bake_tests.c src/lightmap/lm_material.c src/lightmap/lm_mesh_bake.c src/lightmap/lm_svo_voxelize.c src/lightmap/lm_gi_gather.c src/lightmap/lm_parallel.c src/lightmap/lm_mesh_luxel.c src/lightmap/lm_image.c src/lightmap/lm_farfield.c src/lightmap/lm_sky.c src/lightmap/lm_svo_mip.c src/lightmap/lm_svo_material.c src/lightmap/lm_kdtree.c src/lightmap/lm_solve.c src/lightmap/lm_visibility.c src/lightmap/lm_light.c src/lightmap/lm_atlas.c src/lightmap/lm_lightmap.c src/lightmap/lm_sh.c src/math/vec3.c src/memory/arena_init.c src/memory/arena_alloc.c src/memory/arena_mark.c src/memory/arena_pop.c src/npc/nav/npc_svo_init.c src/npc/nav/npc_svo_rasterize.c src/npc/nav/npc_svo_blocker.c include/ferrum/lightmap/lm_mesh_bake.h | build
	$(CC) $(CFLAGS) tests/lightmap/lm_mesh_bake_tests.c src/lightmap/lm_material.c src/lightmap/lm_mesh_bake.c src/lightmap/lm_svo_voxelize.c src/lightmap/lm_gi_gather.c src/lightmap/lm_parallel.c src/lightmap/lm_mesh_luxel.c src/lightmap/lm_image.c src/lightmap/lm_farfield.c src/lightmap/lm_sky.c src/lightmap/lm_svo_mip.c src/lightmap/lm_svo_material.c src/lightmap/lm_kdtree.c src/lightmap/lm_solve.c src/lightmap/lm_visibility.c src/lightmap/lm_light.c src/lightmap/lm_atlas.c src/lightmap/lm_lightmap.c src/lightmap/lm_sh.c src/math/vec3.c src/memory/arena_init.c src/memory/arena_alloc.c src/memory/arena_mark.c src/memory/arena_pop.c src/npc/nav/npc_svo_init.c src/npc/nav/npc_svo_rasterize.c src/npc/nav/npc_svo_blocker.c src/lightmap/gpu/lm_gpu_gather.c src/lightmap/lm_sdf_file.c src/lightmap/gpu/lm_gpu_pack.c src/lightmap/gpu/lm_gpu_gather_chunked.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c -o $@ -ldl -lm
...
build/lm_gather_cmp: tests/visual/lm_gather_cmp.c src/lightmap/gpu/lm_gpu_gather.c src/lightmap/gpu/lm_gpu_gather_chunked.c src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c src/lightmap/lm_sdf_file.c src/lightmap/gpu/lm_gpu_pack.c src/lightmap/lm_material.c src/lightmap/lm_mesh_bake.c src/lightmap/lm_svo_voxelize.c src/lightmap/lm_gi_gather.c src/lightmap/lm_parallel.c src/lightmap/lm_mesh_luxel.c src/lightmap/lm_image.c src/lightmap/lm_farfield.c src/lightmap/lm_sky.c src/lightmap/lm_svo_mip.c src/lightmap/lm_svo_material.c src/lightmap/lm_kdtree.c src/lightmap/lm_solve.c src/lightmap/lm_visibility.c src/lightmap/lm_light.c src/lightmap/lm_atlas.c src/lightmap/lm_lightmap.c src/lightmap/lm_sh.c src/memory/arena_init.c src/memory/arena_alloc.c src/memory/arena_mark.c src/memory/arena_pop.c src/npc/nav/npc_svo_init.c src/npc/nav/npc_svo_rasterize.c src/npc/nav/npc_svo_blocker.c src/renderer/pbr_shader.c src/renderer/material.c src/renderer/texture_create.c src/renderer/texture_upload.c src/renderer/texture_bind.c src/renderer/shader_program_create.c src/renderer/shader_program_bind.c src/renderer/shader_program_destroy.c src/renderer/shader_program_handle.c src/renderer/shader_uniforms_init.c src/renderer/gl_loader_validate.c src/math/mat4_proj.c src/math/mat4_look_at.c src/math/mat4_mul.c src/math/mat4_basic.c src/math/vec3.c $(OBJ_GLAD) src/renderer/render_forward.c src/renderer/shadow_cube.c src/renderer/shadow_spot.c src/renderer/shadow_csm_init.c src/renderer/shadow_csm_cascade.c src/renderer/shadow_csm_render.c src/renderer/shadow_csm_mask.c src/renderer/shadow_caustics_init.c src/renderer/shadow_caustics_bake.c src/renderer/shadow_csm_bind.c src/renderer/shadow_csm_blur.c src/renderer/resource/shadow_atlas.c src/renderer/resource/shadow_slotmap.c src/renderer/resource/gpu_registry_create.c src/renderer/resource/gpu_registry_access.c src/memory/pool_alloc.c src/memory/pool_destroy.c src/memory/pool_free.c src/memory/pool_get.c src/memory/pool_init.c src/memory/arena_reset.c src/memory/apool_alloc.c src/memory/apool_init.c src/memory/apool_get.c src/memory/apool_free.c src/memory/apool_destroy.c src/renderer/resource/gpu_cmd_queue.c src/renderer/resource/gpu_executor.c $(JOB_SRC) src/renderer/cull/frustum_cull.c src/renderer/cull/sphere_cull.c src/renderer/depth_prepass.c src/renderer/render_pipeline_graph.c src/renderer/forward_plus.c src/renderer/cluster_grid.c src/renderer/render_camera.c src/renderer/render_scene.c $(RENDER_WORLD_SRC) src/renderer/gi/gi_runtime.c src/renderer/gi/gi_brick_gpu.c src/renderer/gi/gi_runtime_bricks.c src/renderer/gi/gi_probe_gpu_dyn.c src/renderer/gi/gi_runtime_static.c src/renderer/gi/gi_static_volume.c src/renderer/gi/gi_vis_prepass.c src/renderer/gi/gi_sdf_stream.c src/renderer/gi/gi_probe_gpu.c src/renderer/gi/gi_probe_gpu_active.c src/renderer/gi/gi_probe_tuning.c src/renderer/gi/gi_probe_set.c src/renderer/gi/gi_probe_grid.c src/renderer/gi/gi_probe_place.c src/renderer/gi/gi_sdf.c src/renderer/light_store.c src/mesh/obj_mesh_load.c src/mesh/dmesh_load.c src/renderer/mesh/static_mesh_create.c src/renderer/mesh/static_mesh_destroy.c src/renderer/mesh/static_mesh_draw.c src/renderer/mesh/static_mesh_primitives.c src/renderer/vao_create.c src/renderer/vao_bind_attributes.c src/renderer/vao_destroy.c src/renderer/vbo_create.c src/renderer/vbo_upload.c src/renderer/vbo_destroy.c src/math/mat4_inverse.c | build
	$(CC) $(CFLAGS) $(RENDERER_TEST_CFLAGS) tests/visual/lm_gather_cmp.c src/lightmap/gpu/lm_gpu_gather.c src/lightmap/gpu/lm_gpu_gather_chunked.c src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c src/lightmap/lm_sdf_file.c src/lightmap/gpu/lm_gpu_pack.c src/lightmap/lm_material.c src/lightmap/lm_mesh_bake.c src/lightmap/lm_svo_voxelize.c src/lightmap/lm_gi_gather.c src/lightmap/lm_parallel.c src/lightmap/lm_mesh_luxel.c src/lightmap/lm_image.c src/lightmap/lm_farfield.c src/lightmap/lm_sky.c src/lightmap/lm_svo_mip.c src/lightmap/lm_svo_material.c src/lightmap/lm_kdtree.c src/lightmap/lm_solve.c src/lightmap/lm_visibility.c src/lightmap/lm_light.c src/lightmap/lm_atlas.c src/lightmap/lm_lightmap.c src/lightmap/lm_sh.c src/memory/arena_init.c src/memory/arena_alloc.c src/memory/arena_mark.c src/memory/arena_pop.c src/npc/nav/npc_svo_init.c src/npc/nav/npc_svo_rasterize.c src/npc/nav/npc_svo_blocker.c src/renderer/pbr_shader.c src/renderer/material.c src/renderer/texture_create.c src/renderer/texture_upload.c src/renderer/texture_bind.c src/renderer/shader_program_create.c src/renderer/shader_program_bind.c src/renderer/shader_program_destroy.c src/renderer/shader_program_handle.c src/renderer/shader_uniforms_init.c src/renderer/gl_loader_validate.c src/math/mat4_proj.c src/math/mat4_look_at.c src/math/mat4_mul.c src/math/mat4_basic.c src/math/vec3.c $(OBJ_GLAD) src/renderer/render_forward.c src/renderer/shadow_cube.c src/renderer/shadow_spot.c src/renderer/shadow_csm_init.c src/renderer/shadow_csm_cascade.c src/renderer/shadow_csm_render.c src/renderer/shadow_csm_mask.c src/renderer/shadow_caustics_init.c src/renderer/shadow_caustics_bake.c src/renderer/shadow_csm_bind.c src/renderer/shadow_csm_blur.c src/renderer/resource/shadow_atlas.c src/renderer/resource/shadow_slotmap.c src/renderer/resource/gpu_registry_create.c src/renderer/resource/gpu_registry_access.c src/memory/pool_alloc.c src/memory/pool_destroy.c src/memory/pool_free.c src/memory/pool_get.c src/memory/pool_init.c src/memory/arena_reset.c src/memory/apool_alloc.c src/memory/apool_init.c src/memory/apool_get.c src/memory/apool_free.c src/memory/apool_destroy.c src/renderer/resource/gpu_cmd_queue.c src/renderer/resource/gpu_executor.c $(JOB_SRC) src/renderer/cull/frustum_cull.c src/renderer/cull/sphere_cull.c src/renderer/depth_prepass.c src/renderer/render_pipeline_graph.c src/renderer/forward_plus.c src/renderer/cluster_grid.c src/renderer/render_camera.c src/renderer/render_scene.c $(RENDER_WORLD_SRC) src/renderer/gi/gi_runtime.c src/renderer/gi/gi_brick_gpu.c src/renderer/gi/gi_runtime_bricks.c src/renderer/gi/gi_probe_gpu_dyn.c src/renderer/gi/gi_runtime_static.c src/renderer/gi/gi_static_volume.c src/renderer/gi/gi_vis_prepass.c src/renderer/gi/gi_sdf_stream.c src/renderer/gi/gi_probe_gpu.c src/renderer/gi/gi_probe_gpu_active.c src/renderer/gi/gi_probe_tuning.c src/renderer/gi/gi_probe_set.c src/renderer/gi/gi_probe_grid.c src/renderer/gi/gi_probe_place.c src/renderer/gi/gi_sdf.c src/renderer/light_store.c src/mesh/obj_mesh_load.c src/mesh/dmesh_load.c src/renderer/mesh/static_mesh_create.c src/renderer/mesh/static_mesh_destroy.c src/renderer/mesh/static_mesh_draw.c src/renderer/mesh/static_mesh_primitives.c src/renderer/vao_create.c src/renderer/vao_bind_attributes.c src/renderer/vao_destroy.c src/renderer/vbo_create.c src/renderer/vbo_upload.c src/renderer/vbo_destroy.c src/math/mat4_inverse.c -o $@ $(RENDERER_TEST_LIBS) -ldl -lm
...
LM_HALL_BAKE_SRC := src/mesh/dmesh_load.c src/mesh/obj_mesh_load.c \
  ...
  src/lightmap/gpu/lm_gpu_gather.c src/lightmap/gpu/lm_gpu_gather_chunked.c src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c src/lightmap/lm_sdf_file.c src/lightmap/gpu/lm_gpu_pack.c \
  src/lightmap/gpu/lm_gpu_gather_chunked.c src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c src/lightmap/lm_chunk_svo.c \
  src/renderer/chunk/chunk_grid_init.c src/lightmap/lm_chunk_svo.c src/renderer/chunk/chunk_grid_index.c src/renderer/chunk/chunk_grid_bounds.c \
