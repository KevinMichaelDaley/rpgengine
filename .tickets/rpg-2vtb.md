...
parent: rpg-2lyk
---
# LA gen F5: Utility parasite conduit
...
ferrum.la_ab_parasite per doc F5: surface-walking conduit runs + node pods over a host facade, branch probability, pulsing emissive.
...
State enum: dormant/active/damaged. Breakers: branch density, pod family, entry/exit points.
