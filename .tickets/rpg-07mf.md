...
Deliverables:
- include/ferrum/renderer/mesh/mesh_registry.h: mesh_handle_t (index+generation), mesh_type_t enum (STATIC/SKELETAL), mesh_registry_t struct with 4096 capacity, freelist
